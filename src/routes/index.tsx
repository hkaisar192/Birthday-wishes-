...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A special birthday wish for the most amazing best friend in the world.",
      },
    ],
  }),
});
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-16 sm:py-24">
          ...
          <div className="relative">
            <div className="photo-frame rounded-3xl p-2 animate-glow-pulse">
              <div className="w-56 h-56 sm:w-72 sm:h-72 rounded-2xl overflow-hidden bg-muted flex items-center justify-center">
                ...
                <img src={photoFrame} alt="Best friend" className="w-full h-full object-cover" />
              </div>
            </div>
            <span className="absolute -top-4 -right-4 text-3xl animate-float-gentle">🌸</span>
            <span
              className="absolute -bottom-4 -left-4 text-3xl animate-float-gentle"
        ...
        >
          ...
          >
            Every moment with you is a blessing I never take for granted. You've been my shoulder to
            cry on, my partner in laughter, and the most beautiful soul I've ever known. Your
            kindness, your strength, and your warm heart inspire me every single day. Today, the
            world celebrates the day it was gifted with someone as extraordinary as you. I hope this
            year brings you all the love, happiness, and dreams your heart can hold. You deserve
            every beautiful thing life has to offer. 💕
          </p>
        </motion.div>
