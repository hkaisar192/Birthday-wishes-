      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, var(--card), var(--lavender-soft), var(--rose-soft))",
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              On this beautiful day, I just want you to know that you make the world a better place
              simply by being in it. Your smile lights up every room, and your heart is pure gold.
